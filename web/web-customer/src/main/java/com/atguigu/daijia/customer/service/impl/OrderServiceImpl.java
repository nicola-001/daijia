...
public class OrderServiceImpl implements OrderService {
    ...
    public Integer getOrderStatus(Long orderId) {
        ...
        Result<Integer> orderStatus = orderStatusResult;
        if (orderStatus == null) {
            return new GuiguException(ResultCodeEnum.DATA_ERROR).getCode();
        }
    ...
    public DriverInfoVo getDriverInfo(Long orderId, Long customerId) {
        ...
        Result<DriverInfoVo> driverInfoOrder = driverInfoFeignClient.getDriverInfoOrder(orderInfo.getDriverId());
        if (driverInfoOrder.getCode() != 200) {
            throw new GuiguException(ResultCodeEnum.DATA_ERROR);
        }
    ...
    public OrderServiceLastLocationVo getOrderServiceLastLocation(Long orderId) {
        ...
        Result<OrderServiceLastLocationVo> orderServiceLastLocation = locationFeignClient.getOrderServiceLastLocation(orderId);
        System.out.println("orderServiceLastLocation" + orderServiceLastLocation);
